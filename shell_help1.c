...
/**
 * hlp_cd - Displays information on the shellby builtin command 'cd'.
 */
void hlp_cd(void)
{
...
/**
 * hlp_all - Displays all possible builtin shellby commands.
 */
void hlp_all(void)
{
...
/**
 * hlp_alias - Displays information on the shellby builtin command 'alias'.
 */
void hlp_alias(void)
{
...
/**
 * hlp_hlp - Displays information on the shellby builtin command 'hlp'.
 */
void hlp_hlp(void)
{
...
/**
 * hlp_exit - Displays information on the shellby builtin command 'exit'.
 */
void hlp_exit(void)
{
